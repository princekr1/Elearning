  ...
  <ul  class="nav navbar-nav">
   ...
   <div class="navbar-right">
     ...
     <div class="container-fluid" id="content">
            <div class="row decor_bg">
                <div class="col-md-6 col-md-offset-3">
                    <table class="table table-striped">
						...
						<br /><br />
						<br /><br />
						<h1 style="color:black">Course Details</h1>
						<hr>
                            <thead>
                                <tr>
                                    <th>No of Course</th>
							...
							<td>
							<div class="progress">
							<div class="progress-bar-success" style="width:70%">50%</div>
							</div></td>
							<td><a href='#' class='btn btn-primary'>Go To Course</a></td></tr>
		...
		<!-- footer Start-->
<footer class="container-fluid" style="margin-top:-1%;" background=white">
      <div class="row">
    <div class="col-xs-4">
    <h4>Information</h4>
              <a href="#">About Us</a>
